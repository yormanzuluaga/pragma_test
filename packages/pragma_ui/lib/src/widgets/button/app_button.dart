...
class AppButton extends StatelessWidget {
  ...
  const AppButton._({
    ...
    super.key,
        ...
        _disabledButtonColor = disabledButtonColor ?? AppColors.neutral02,
  ...
  const AppButton.secondary({
    ...
    Size? minimumSize,
          ...
          disabledButtonColor: disabledButtonColor ?? AppColors.neutral02,
          elevation: elevation,
          textStyle: textStyle,
          padding: padding,
          icon: icon,
  ...
  static const _smallPaddingTitle = EdgeInsets.symmetric(horizontal: AppSpacing.xs);

  /// The padding of the the button.
  static const _defaultPadding = EdgeInsets.symmetric(vertical: 0);
  ...
  Widget build(BuildContext context) {
    ...
    return ElevatedButton(
      ...
      style: ButtonStyle(
        ...
        backgroundColor: onPressed == null ? WidgetStateProperty.all(_disabledButtonColor) : WidgetStateProperty.all(_buttonColor),
        elevation: WidgetStateProperty.all(_elevation),
        foregroundColor: onPressed == null ? WidgetStateProperty.all(_disabledForegroundColor) : WidgetStateProperty.all(_foregroundColor),
